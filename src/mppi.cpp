...
Eigen::Vector2d MPPI::control(Eigen::Vector4d curr_state, Eigen::Vector4d goal_state, double acceleration = 0.0){
    ...
    for(int i = 0; i < m_mppiParams.number_rollouts; i++){
        Path newPath(m_pathParams, curr_state, goal_state, acceleration);
